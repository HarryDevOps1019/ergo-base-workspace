    ...
    <>
      ...
      <div className="bg-gold text-gold-foreground text-center py-2 px-4 text-xs font-semibold tracking-widest">
        <span className="hidden sm:inline">
          📞 FREE WORKSPACE CONSULT — TALK TO OUR ERGONOMICS EXPERT BEFORE YOU
          BUY
        </span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link to="/" className="flex items-center gap-3">
              <img src={logo} alt="Ergo Base" className="h-14 object-contain" />
              <span className="text-lg font-bold tracking-wider text-foreground hidden sm:inline">
                ERGO BASE
              </span>
            </Link>
